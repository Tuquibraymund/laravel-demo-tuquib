...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">WELCOME TO SCHOOL MANAGEMENT SYSTEM</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Not a member?
      <a href="{{route('form_signup')}}" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign Up</a>
    </p>
  </div>
</div>
</body>
